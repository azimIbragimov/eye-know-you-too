...
class CustomModel(nn.Module):
    def __init__(self, input_shape=2500):
        super().__init__()

        # Branch 1 (input_1)
        self.s1_c1 = ConvBlock(in_channels=2, out_channels=128, kernel_size=9)
        ...
        # Branch 2 (input_2)
        self.s2_c1 = ConvBlock(in_channels=2, out_channels=32, kernel_size=9)
...
class Model(nn.Module):
    def __init__(
        ...
        self.embedder = CustomModel(input_shape=seq_len//2)
