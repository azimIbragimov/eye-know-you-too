...
CUDA_VISIBLE_DEVICES=0 python src/train.py --ds=0 --fold=0
CUDA_VISIBLE_DEVICES=0 python src/train.py --ds=0 --fold=1
CUDA_VISIBLE_DEVICES=0 python src/train.py --ds=0 --fold=2
CUDA_VISIBLE_DEVICES=0 python src/train.py --ds=0 --fold=3
